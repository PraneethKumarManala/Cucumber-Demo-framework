...
@CucumberOptions(features="src/test/java/com/cucumber/xfinity/features/XfinityInternet.feature",
...
plugin= {"pretty:cucumberreports/cucumber-pretty.txt",
          ...
          "com.cucumber.listener.ExtentCucumberFormatter:cucumberreports/Xfinity_Internet.html"
}
)
public class XfinityInternetRunner extends AbstractTestNGCucumberTests{
