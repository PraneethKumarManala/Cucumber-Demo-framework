...
@CucumberOptions(features="src/test/java/com/cucumber/features/CRMLogin_Example.feature",
                 ...
                 plugin= {"pretty:cucumberreports/cucumber-pretty.txt",
                		 ...
                		 "com.cucumber.listener.ExtentCucumberFormatter:cucumberreports/extentReport_ExampleKeyWord.html"
                		})
public class CRMLogin_ExampleRunner extends AbstractTestNGCucumberTests{
