...
@CucumberOptions(features="src/test/java/com/cucumber/xfinity/features",
...
plugin= {"pretty:cucumberreports/cucumber-pretty.txt",
          ...
          "com.cucumber.listener.ExtentCucumberFormatter:cucumberreports/Xfinity_All.html"
}
)
public class Xfinity_All_Runner extends AbstractTestNGCucumberTests{
