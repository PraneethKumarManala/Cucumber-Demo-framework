...
@CucumberOptions(features="src/test/java/com/cucumber/xfinity/features/XfinityTV.feature",
...
plugin= {"pretty:cucumberreports/cucumber-pretty.txt",
          ...
          "com.cucumber.listener.ExtentCucumberFormatter:cucumberreports/Xfinity_TV.html"
}
)
public class XfinityTVRunner extends AbstractTestNGCucumberTests{
