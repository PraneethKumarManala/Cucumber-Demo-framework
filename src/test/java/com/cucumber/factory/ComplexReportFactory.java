...
public class ComplexReportFactory {
	...
	private synchronized static ExtentReports getExtentReport() {
		if (reporter == null) {
			...
			//reporter = new ExtentReports(System.getProperty("user.dir") +"\\Results\\AutomationReport.html", true, DisplayOrder.NEWEST_FIRST);
			//reporter = new ExtentReports("..\\automation-acdc\\"+Base.filePath()+"AutomationReport_"+Base.timeStamp+".html", true, DisplayOrder.NEWEST_FIRST);
			//reporter = new ExtentReports(System.getProperty("user.dir")+"\\"+Base.filePath()+"SummaryResults_"+Base.timeStamp+".html", true, DisplayOrder.NEWEST_FIRST);
			//reporter = new ExtentReports(System.getProperty("user.dir")+"/"+Base.filePath()+"SummaryResults_"+Base.timeStamp+".html", true, DisplayOrder.NEWEST_FIRST);
			htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir")+"/"+Base.filepath()+"SummaryResults_"+Base.timeStamp+".html");
