...
public class XfinityInternet {


private static final Logger loger = Logger.getLogger(XfinityInternet.class.getName());
	...
	@Given("^click on XFINITY Internet link$")
	public void click_on_XFINITY_Internet_link() {
		 
		  Base.setUp();
		  crm.enterURL();
		  crm.xfinityInternetlink();
